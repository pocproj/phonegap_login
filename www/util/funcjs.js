...
/**
 * Returns a nested property from an object by a path string
 * @param obj The queried object
 * @param path A path to a member e.g.: 'user.username'
 * @param delimiter the delimeter in the path, defaults to '.'
 * @returns {*}
 */
function getPropertyByPath(obj, path, delimiter){
	if(!arguments[1])
		return obj;
